            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()){
                    case R.id.acao_inicio:
                        it = new Intent(Equipe.this, PrincipalActivity.class);
                        break;

                    case R.id.acao_denuncia:
                        it = new Intent(Equipe.this, Denuncia.class);
                        break;

                    case R.id.acao_mapa:
                        it = new Intent(Equipe.this, Maps.class);
                        break;

                    case R.id.acao_minhas_denuncias:
                        it = new Intent(Equipe.this, ListaDenuncias.class);
                        break;

                    case R.id.acao_dicas:
                        it = new Intent(Equipe.this, Dicas.class);
                        finish();
                        break;
                }
                startActivity(it);
